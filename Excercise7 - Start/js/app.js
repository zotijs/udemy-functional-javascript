...
//that always acts on the users array but allows you to enter a user name.
//Have it  return a clone of that user.
const getUserCurried = pipe(
  curry(getUser)(users),
  cloneObj
);

console.log(getUserCurried("James"));
...
//It should accepts a new score and then return a new array that contains the updated score and tries.
//To compose this function you may need to create other functions.

const updateHenry = pipe(
  curry(updateScore)(getUserCurried("Henry")),
  cloneObj,
  updateTries,
